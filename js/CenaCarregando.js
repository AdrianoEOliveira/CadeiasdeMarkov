...
export default class CenaCarregando extends Cena {
  desenhar() {
    ...
    if (this.assets.acabou()) {
      ...
      this.ctx.fillText(
        "Aperte 2 a 4 para mapa circulo com grid 3,5,10",
        this.canvas.width / 2,
        this.canvas.height / 2 + 120
      );
      this.ctx.fillText(
        "Aperte 5 a 7 para mapa quadrado com grid 3,5,10",
        this.canvas.width / 2,
        this.canvas.height / 2 + 160
      );
      this.ctx.fillText(
        "Quando travar ou mudar o teste recarrege a pagina",
        this.canvas.width / 2,
